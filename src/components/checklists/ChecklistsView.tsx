...
const s: Record<string, React.CSSProperties> = {
  ...
  listItemActive: { borderColor: "hsl(var(--primary))", background: "hsl(var(--primary))", color: "white" },
  ...
  saveBtn: { marginTop: 16, padding: "10px 20px", background: "hsl(var(--primary))", color: "white", border: "none", borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: "pointer" },
